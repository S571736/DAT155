...
var LOWER_FINGER_WIDTH = 0.3;
var LOWER_FINGER_HEIGHT = 1.0;
var UPPER_FINGER_WIDTH = 0.3;
var UPPER_FINGER_HEIGHT = 1.0;
...
function lowerFinger() {
    var s = scale(LOWER_FINGER_WIDTH, LOWER_FINGER_HEIGHT, LOWER_FINGER_WIDTH);
...
function upperFinger() {
    var s = scale(UPPER_FINGER_WIDTH, UPPER_FINGER_HEIGHT, UPPER_FINGER_WIDTH);
...
var render = function () {
    ...
    modelViewMatrix = mult(modelViewMatrix, rotate(theta[UpperFinger], vec3(0, 0, 1)));
    upperFinger();

    modelViewMatrix = stack.pop();


    modelViewMatrix = mult(modelViewMatrix, translate(0.3, UPPER_ARM_HEIGHT, 0.0));
    modelViewMatrix = mult(modelViewMatrix, rotate(-theta[LowerFinger], vec3(0,0,1)));
    lowerFinger();
